...
import os
makepath = lambda *locs: [os.path.join(os.path.dirname(__file__), '..', loc) for loc in locs]
...
SECRET_KEY = '8*_8unwg@6ffh^9u$kap7k(86fgu3u)--_zrc)(&26djiju@+d'
